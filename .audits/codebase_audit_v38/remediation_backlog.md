...
## Epic E1 - Close publication artifact and attestation gaps [x]
...
### Ticket E1-T1 - Add post-upload draft release verification [x]
...
### Ticket E1-T2 - Require publication mode for online attestation verification [x]
...
### Ticket E1-T3 - Validate release summary publication invariants [x]
...
## Epic E2 - Harden retained log and evidence parser contracts [x]
...
### Ticket E2-T1 - Cross-check summary log paths against retained archive [x]
...
### Ticket E2-T2 - Add govulncheck parser fixture coverage [x]
...
### Ticket E2-T3 - Add contrib drift parser fixture coverage [x]
...
## Epic E3 - Consolidate reviewer release path [x]
...
### Ticket E3-T1 - Add a reviewer summary command [x]
...
### Ticket E3-T2 - Normalize release docs around the single reviewer path [x]
...
## Epic E4 - Prepare response writer and idempotency v3 cleanup [x]
...
### Ticket E4-T1 - Inventory remaining `response_writer` dependents [x]
...
### Ticket E4-T2 - Add guardrails for new `response_writer` usage [x]
...
### Ticket E4-T3 - Define tokenless idempotency sunset evidence [x]
...
## Epic E5 - Prepare billing and database stats v3 cleanup [x]
...
### Ticket E5-T1 - Add billing compatibility usage guardrails [x]
...
### Ticket E5-T2 - Add database stats direct-use guardrails [x]
...
### Ticket E5-T3 - Add v3 removal checklist tests [x]
