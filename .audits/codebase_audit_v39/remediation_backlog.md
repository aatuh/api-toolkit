...
## Epic E1 - Burn down imported-only vulnerability dispositions [ ]
...
### Ticket E1-T1 - Map current imported-only advisory ownership [ ]
...
### Ticket E1-T2 - Upgrade or isolate pgx imported-only advisories [ ]
...
### Ticket E1-T3 - Upgrade or isolate grpc imported-only advisory [ ]
...
### Ticket E1-T4 - Refresh vulnerability dispositions after dependency work [ ]
...
## Epic E2 - Harden contrib drift evidence and current drift handling [ ]
...
### Ticket E2-T1 - Add mixed same-package drift parser fixture [ ]
...
### Ticket E2-T2 - Decide devheaders incompatible drift outcome [ ]
...
### Ticket E2-T3 - Add consumer-facing contrib drift guidance [ ]
...
## Epic E3 - Prepare v3 compatibility cleanup [ ]
...
### Ticket E3-T1 - Strengthen billing compatibility guardrails [ ]
...
### Ticket E3-T2 - Reduce database stats compatibility usage [ ]
...
### Ticket E3-T3 - Inventory and migrate response_writer internal users [ ]
...
### Ticket E3-T4 - Expand token-aware idempotency release evidence [ ]
...
### Ticket E3-T5 - Prepare v3 migration notes for compatibility removals [ ]
...
## Epic E4 - Improve local release artifact audit reproducibility [ ]
...
### Ticket E4-T1 - Add a documented verifier fixture command [ ]
...
### Ticket E4-T2 - Keep release-review-summary in release review flow [ ]
