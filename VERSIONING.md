...
`make release-tag-consistency-check` requires matching root and contrib release
tags at the same default-branch commit, matching module-major paths, and the
release entries and baseline needed by the current two-module release policy.
