...
full-profile-scaffold-check: ## Generate and validate the saas-api-full scaffold, OpenAPI, contracts, Go client, resource generator, and providers
	@(cd contrib && $(GO) test ./cmd/api-toolkit -count=1 -run '^(TestNewServiceGeneratesBuildableSaaSAPIFull|TestNewServiceGeneratesBuildableSaaSAPIFullWithOIDC|TestNewServiceGeneratesBuildableSaaSAPIFullWithJWT|TestNewServiceGeneratesBuildableSaaSAPIFullWithClerk|TestGenerateResourceAddsTenantScopedCRUDToFullProfile|TestNewServiceGeneratesFullProfileProviderWorkflows)$$')
