...
| Provider adapter split | The current decision stays in `docs/provider-adapter-split.md`; provider families can split only when contrib becomes too broad for installation, review, or release cadence. |
