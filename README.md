...
- Run recording uses a short-lived cleanup context after the job returns, so graceful shutdown can still persist the final outcome and keep `LastFinished`-based restart suppression accurate.
