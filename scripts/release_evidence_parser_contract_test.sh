...
github.com/aatuh/api-toolkit/contrib/v4/pkg/compatible	compatible	contract fixture	not_required	2026-05-01	2099-01-01	contrib
github.com/aatuh/api-toolkit/contrib/v4/pkg/incompatible	incompatible	contract fixture	docs/release-notes.md package-tied incompatible contrib acknowledgement	2026-05-01	2099-01-01	contrib
github.com/aatuh/api-toolkit/contrib/v4/pkg/mixed	incompatible	contract fixture with compatible and incompatible headings in one package	docs/release-notes.md package-tied incompatible contrib acknowledgement	2026-05-01	2099-01-01	contrib
github.com/aatuh/api-toolkit/contrib/v4/pkg/malformed	compatible	contract fixture	not_required	2026-05-01	2099-01-01	contrib
TSV

cat >"$repo_root/logs/contrib-compatible.log" <<'LOG'
Contrib API drift report (report-only)
DRIFT github.com/aatuh/api-toolkit/contrib/v4/pkg/compatible
Compatible changes:
- added method
...
Contrib API drift report (report-only)
DRIFT github.com/aatuh/api-toolkit/contrib/v4/pkg/incompatible
...
Contrib API drift report (report-only)
DRIFT github.com/aatuh/api-toolkit/contrib/v4/pkg/mixed
Incompatible changes:
...
Contrib API drift report (report-only)
OK   github.com/aatuh/api-toolkit/contrib/v4/pkg/compatible
...
Contrib API drift report (report-only)
SKIP github.com/aatuh/api-toolkit/contrib/v4/pkg/skipped (missing in baseline or working tree)
...
Contrib API drift report (report-only)
DRIFT github.com/aatuh/api-toolkit/contrib/v4/pkg/malformed
Unexpected heading:
...
if compatible["packages"] != [{"package": "github.com/aatuh/api-toolkit/contrib/v4/pkg/compatible", "status": "compatible"}]:
    raise SystemExit(f"compatible drift fixture parsed incorrectly: {compatible}")
if incompatible["packages"] != [{"package": "github.com/aatuh/api-toolkit/contrib/v4/pkg/incompatible", "status": "incompatible"}]:
    raise SystemExit(f"incompatible drift fixture parsed incorrectly: {incompatible}")
if mixed["packages"] != [{"package": "github.com/aatuh/api-toolkit/contrib/v4/pkg/mixed", "status": "incompatible"}]:
...
if malformed["packages"] != [{"package": "github.com/aatuh/api-toolkit/contrib/v4/pkg/malformed", "status": "unknown"}]:
