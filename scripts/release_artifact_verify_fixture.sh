...
summary = {
    ...
    "release_identity": {
        ...
        "default_branch_commit": "fixture-branch",
        ...
        "workflow": {"provider": "github_actions", "repository": "aatuh/api-toolkit", "expected_repository": "aatuh/api-toolkit", "workflow": "release", "workflow_ref": "aatuh/api-toolkit/.github/workflows/release.yml@refs/heads/master", "ref": "refs/tags/v4.0.2", "sha": "fixture", "trusted": True, "reason": "synthetic fixture"},
        "status": "passed",
