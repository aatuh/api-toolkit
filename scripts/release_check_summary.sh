...
full_profile_scaffold_evidence_json() {
  ...
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v3/cmd/api-toolkit TestNewServiceGeneratesBuildableSaaSAPIFull*",'
  ...
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v3/cmd/api-toolkit TestClientsTypeScriptGeneratesFetchPackage",'
  printf '"status":'; json_string "$client_status"; printf ','
  printf '"log_path":'; json_string "$log_dir/full-profile-scaffold-check.log"; printf ','
  ...
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v3/cmd/api-toolkit TestGenerateResourceAddsTenantScopedCRUDToFullProfile",'
  ...
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v3/cmd/api-toolkit TestNewServiceGeneratesFullProfileProviderWorkflows",'
  ...
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v3/cmd/api-toolkit TestOpsObservabilityGeneratesBundle",'
  printf '"status":'; json_string "$scaffold_status"; printf ','
  printf '"release_blocking":true'
  printf '},'
  ...
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v3/cmd/api-toolkit TestNewServiceGeneratesSaaSWebSessionProfile",'
  printf '"status":'; json_string "$scaffold_status"; printf ','
  printf '"release_blocking":true'
  printf '},'
  printf '"worker_check":{'
