...
api_check_packages() {
  ...
  awk '
    ...
    in_packages && /^\)/ { exit }
    in_packages {
	  if (match($0, /"github\.com\/aatuh\/api-toolkit\/v4[^"]+"/)) {
...
full_profile_scaffold_evidence_json() {
  ...
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v4/cmd/api-toolkit TestNewServiceGeneratesBuildableSaaSAPIFull*",'
  ...
  printf '},'
  printf '"typescript_client_generation":{'
  printf '"make_target":"client-ts-check",'
  printf '"command_line":'; json_string "api-toolkit clients typescript --openapi <file> --out <dir> --package-name <name> --style fetch"; printf ','
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v4/cmd/api-toolkit TestClientsTypeScriptGeneratesFetchPackage",'
  printf '"status":'; json_string "$client_status"; printf ','
  printf '"log_path":'; json_string "$log_dir/full-profile-scaffold-check.log"; printf ','
  printf '"checked_in_output":"when --client typescript is selected"'
  printf '},'
  ...
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v4/cmd/api-toolkit TestGenerateResourceAddsTenantScopedCRUDToFullProfile",'
  printf '"status":'; json_string "$resource_status"; printf ','
  printf '"log_path":'; json_string "$log_dir/full-profile-scaffold-check.log"; printf ','
  printf '"release_blocking":true'
  printf '},'
  printf '"provider_flag_generation":{'
  printf '"flags":'; json_string_array "--with stripe-billing" "--with resend-email" "--with clerk-webhooks" "--with entitlements"; printf ','
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v4/cmd/api-toolkit TestNewServiceGeneratesFullProfileProviderWorkflows",'
  printf '"status":'; json_string "$provider_status"; printf ','
  printf '"log_path":'; json_string "$log_dir/full-profile-scaffold-check.log"; printf ','
  printf '"release_blocking":true'
  printf '},'
  printf '"observability_bundle":{'
  printf '"command_line":'; json_string "api-toolkit ops observability --profile saas-api-full --out <dir>"; printf ','
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v4/cmd/api-toolkit TestOpsObservabilityGeneratesBundle",'
  printf '"status":'; json_string "$scaffold_status"; printf ','
  printf '"release_blocking":true'
  printf '},'
  printf '"asset_validation":{'
  printf '"make_targets":'; json_string_array "asset-check" "observability-check" "deploy-check"; printf ','
  printf '"command_line":'; json_string "generated saas-api-full service: make asset-check observability-check deploy-check"; printf ','
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v4/cmd/api-toolkit TestNewServiceGeneratesFullProfileProviderWorkflows",'
  printf '"status":'; json_string "$scaffold_status"; printf ','
  printf '"log_path":'; json_string "$log_dir/full-profile-scaffold-check.log"; printf ','
  printf '"release_blocking":true'
  printf '},'
  printf '"deployment_packaging":{'
  printf '"helm":{'
  printf '"command_line":'; json_string "api-toolkit deploy helm --dir <project> --out deploy/helm"; printf ','
  printf '"status":'; json_string "$scaffold_status"; printf ','
  printf '"release_blocking":true'
  printf '},'
  printf '"terraform_aws":{'
  printf '"command_line":'; json_string "api-toolkit deploy terraform --cloud aws --dir <project> --out deploy/terraform/aws"; printf ','
  printf '"status":'; json_string "$scaffold_status"; printf ','
  printf '"release_blocking":true'
  printf '}'
  printf '},'
  printf '"migration_lifecycle":{'
  printf '"commands":'; json_string_array "plan" "up" "status" "check" "verify" "down_guarded"; printf ','
  printf '"guard":"down requires --allow-dangerous-down and ALLOW_DANGEROUS_MIGRATION_DOWN=true",'
  printf '"status":'; json_string "$scaffold_status"; printf ','
  printf '"release_blocking":true'
  printf '},'
  printf '"session_profile":{'
  printf '"profile":"saas-web",'
  printf '"auth_modes":'; json_string_array "session" "oidc-session"; printf ','
  printf '"contract_test":"github.com/aatuh/api-toolkit/contrib/v4/cmd/api-toolkit TestNewServiceGeneratesSaaSWebSessionProfile",'
  printf '"status":'; json_string "$scaffold_status"; printf ','
  printf '"release_blocking":true'
  printf '},'
  printf '"worker_check":{'
