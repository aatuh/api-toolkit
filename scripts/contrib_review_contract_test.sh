...
github.com/aatuh/api-toolkit/contrib/v4/middleware/auth/devheaders	supported-adapter	direct-tests	Dev-header auth middleware.
github.com/aatuh/api-toolkit/contrib/v4/adapters/idempotency	experimental	direct-tests	In-memory idempotency adapter.
github.com/aatuh/api-toolkit/contrib/v4/cmd/api-toolkit	tooling	direct-tests	Developer CLI for service scaffolding and route contract checks.
TSV
...
- `github.com/aatuh/api-toolkit/contrib/v4/cmd/api-toolkit` scaffold behavior changed.
NOTES
...
- `github.com/aatuh/api-toolkit/contrib/v4/cmd/api-toolkit` saas-api-full runtime assets changed.
NOTES
